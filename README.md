...
The tangents generated by this addon looked OK in UE4 in my initial tests, but after some experiments with mikktspace (which UE4 uses natively) it turns out that there is a slight difference in shading
compared to automatically generated tangents. For this reason, it looks like letting UE4 generate tangents is probably a better options than importing them from this exporter.
