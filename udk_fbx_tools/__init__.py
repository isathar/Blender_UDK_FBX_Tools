...
def initdefaults():
	...
	bpy.types.WindowManager.vn_generatemode = bpy.props.EnumProperty(
		...
		items=(('GROUPS', "Smoothing Groups", " *NOT IMPLEMENTED* calculate normals from smoothing groups"),
				...
				('UPVECT', "Up Vector", "Calculate normals pointing up good for some types of foliage + effects"),
				('G_FOLIAGE', "Ground Foliage", "calculate selected normals pointing up, the rest bent from curosr - optimized for ground foliage"),
